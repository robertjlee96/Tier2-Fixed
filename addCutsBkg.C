...
void addCutsBkg(){
    ...
    TFile* fileIn = TFile::Open("./NTuples/Diphotons_M95PTM25_MD20LR045_0216.root");
    ...
    TFile* fileOut = TFile::Open("NTuples/SinglePhoton_DiphotonBkg_M95PTM15_0314_Validation.root","RECREATE");
//    TFile* fileOut = TFile::Open("NTuples/SinglePhoton_GJet_M95PTM15_DPT075_OnlyPromptFakePairs_0120_Validation.root","RECREATE");
    ...
    Float_t hggMassP1,passSPreselP1,passDPreselP1,eventP1,genPtP1,genMatchTypeP1,ptP1,weightP1,scRawEP1,r9P1,sigmaIetaIetaP1,etaWidthP1,phiWidthP1,covIEtaIPhiP1,s4P1,phoIso03P1,chgIsoWrtChosenVtxP1,chgIsoWrtWorstVtxP1,scEtaP1,scEtaSecondP1,esEffSigmaRRP1,esEnergyOverRawEP1,rhoP1,hadTowOverEmP1,hadronicOverEmP1;
    ...
    treeOutP1->Branch("scEtaSecond",&scEtaSecondP1,"scEtaSecond/F");
    ...
    Float_t hggMassP2,passSPreselP2,passDPreselP2,eventP2,genPtP2,genMatchTypeP2,ptP2,weightP2,scRawEP2,r9P2,sigmaIetaIetaP2,etaWidthP2,phiWidthP2,covIEtaIPhiP2,s4P2,phoIso03P2,chgIsoWrtChosenVtxP2,chgIsoWrtWorstVtxP2,scEtaP2,scEtaSecondP2,esEffSigmaRRP2,esEnergyOverRawEP2,rhoP2,hadTowOverEmP2,hadronicOverEmP2;
    ...
    treeOutP2->Branch("scEtaSecond",&scEtaSecondP2,"scEtaSecond/F");
    ...
    Float_t hggMassF1,passSPreselF1,passDPreselF1,eventF1,genPtF1,genMatchTypeF1,ptF1,weightF1,scRawEF1,r9F1,sigmaIetaIetaF1,etaWidthF1,phiWidthF1,covIEtaIPhiF1,s4F1,phoIso03F1,chgIsoWrtChosenVtxF1,chgIsoWrtWorstVtxF1,scEtaF1,scEtaSecondF1,esEffSigmaRRF1,esEnergyOverRawEF1,rhoF1,hadTowOverEmF1,hadronicOverEmF1;
    ...
    treeOutF1->Branch("scEtaSecond",&scEtaSecondF1,"scEtaSecond/F");
    ...
    Float_t hggMassF2,passSPreselF2,passDPreselF2,eventF2 ,genPtF2 ,genMatchTypeF2 ,ptF2 ,weightF2 ,scRawEF2 ,r9F2 ,sigmaIetaIetaF2 ,etaWidthF2 ,phiWidthF2 ,covIEtaIPhiF2 ,s4F2 ,phoIso03F2 ,chgIsoWrtChosenVtxF2 ,chgIsoWrtWorstVtxF2 ,scEtaF2 ,scEtaSecondF2,esEffSigmaRRF2 ,esEnergyOverRawEF2 ,rhoF2 ,hadTowOverEmF2 ,hadronicOverEmF2;
    ...
    treeOutF2 ->Branch("scEtaSecond",&scEtaSecondF2,"scEtaSecond/F");
    ...
    while (myReader.Next()){
        ...
        if(*leadGenMatchType == 1 && *subGenMatchType == 1)){
            if (*hggMassIn > 95.0 && *leadGenMatchType == 1.0 && *leadPt > 17.0 && *leadPt/(*hggMassIn) > 0.15 && *subPt/(*hggMassIn) > 0.15 && *subPt > 17.0){
                ...
                if (*leadPt/(*hggMassIn) > 0.33 && *leadR9 > 0.5 && *leadHadronicOverEm < 0.08 && !(abs(*leadScEta) > 1.5 && *leadR9 < 0.8) && !(abs(*leadScEta) < 1.5 && *leadR9 < 0.85 && (*leadSigmaIetaIeta > 0.015 || *leadPhoIso03 > 4.0 || *leadTrkSumPtHollowConeDR03 > 6.0)) && !(abs(*leadScEta) > 1.5 && *leadR9 < 0.9 && (*leadSigmaIetaIeta > 0.035 || *leadPhoIso03 > 4.0 || *leadTrkSumPtHollowConeDR03 > 6.0))){
                    
                    passSPresel = 1.0;
                    if (*subPt/(*hggMassIn) > 0.25 && *subR9 > 0.5 && *subHadronicOverEm < 0.08 && !(abs(*subScEta) > 1.5 && *subR9 < 0.8) && !(abs(*subScEta) < 1.5 && *subR9 < 0.85 && (*subSigmaIetaIeta > 0.015 || *subPhoIso03 > 4.0 || *subTrkSumPtHollowConeDR03 > 6.0)) && !(abs(*subScEta) > 1.5 && *subR9 < 0.9 && (*subSigmaIetaIeta > 0.035 || *subPhoIso03 > 4.0 || *subTrkSumPtHollowConeDR03 > 6.0))){
                        passDPresel = 1.0;
                    }
                }
            ...
            if (*hggMassIn > 95.0 && *subGenMatchType == 1.0 && *leadPt > 17.0 && *leadPt/(*hggMassIn) > 0.15 && *subPt/(*hggMassIn) > 0.15 && *subPt > 17.0){
                ...
                double passSPresel = 0.0;
                double passDPresel = 0.0;
                if (*subPt/(*hggMassIn) > 0.25 && *subR9 > 0.5 && *subHadronicOverEm < 0.08 && !(abs(*subScEta) > 1.5 && *subR9 < 0.8) && !(abs(*leadScEta) > 1.5 && *leadR9 < 0.8)&& !(abs(*subScEta) < 1.5 && *subR9 < 0.85 && (*subSigmaIetaIeta > 0.015 || *subPhoIso03 > 4.0 || *subTrkSumPtHollowConeDR03 > 6.0)) && !(abs(*subScEta) > 1.5 && *subR9 < 0.9 && (*subSigmaIetaIeta > 0.035 || *subPhoIso03 > 4.0 || *subTrkSumPtHollowConeDR03 > 6.0))){
...
//                    }
//                }
//                passSPreselF2 = passSPresel;
//                passDPreselF2 = passDPresel;
//                treeOutF2->Fill();
//            }
        }
    }
