...
fNames.append("validationNTuples/0309/MD20_LR045_NTree300_M95PTM15_GGH_UL2017_Validation_Endcap")
...
input_values, target_values, orig_weights, train_weights, input_vars, varValsSigIn, varValsBkgIn, varNames = endcapPtCutUtils.load_file(fin,geometry_selection,ptCut)
