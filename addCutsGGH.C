...
<<<<<<< HEAD
    TFile* fileIn = TFile::Open("./NTuples/GGH_M95PTM15_MD20LR045_DPT075_0202.root");
=======
...
<<<<<<< HEAD
    TFile* fileOut = TFile::Open("NTuples/SinglePhoton_GGH_M95_PTM15_0228_Validation.root","RECREATE");
=======
...
<<<<<<< HEAD
    ...
    while (myReader.Next()){
        ...
        if (*hggMassIn > 95 && *leadGenMatchType == 1.0 && *leadPt > 17.0 && *subPt > 17.0 && *leadPt/(*hggMassIn) > 0.15 && *subPt/(*hggMassIn) > 0.15){
        ...
        if (*hggMassIn > 95  && *subGenMatchType == 1.0 && *subPt > 17.0 && *leadPt > 17.0 && *subPt/(*hggMassIn) > 0.15 && *leadPt/(*hggMassIn) > 0.15){
...
<<<<<<< HEAD
    ...
    cout<<"nTotal = "<<nTotal<<" || nPassD = "<<nPassD<<endl;
=======
        }
    }
>>>>>>> 27f7c4344d75d61327757beea580fc85cb3f969b
