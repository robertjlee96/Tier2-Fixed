...
void eventsCutByPresel(bool etaSplit, bool diphotonCuts){
    gROOT->Reset();
    gStyle->SetPalette(1);
    ...
    string gjpLabelPresel = "GJet Prompt Passing Presel & Pt/M";
    string gjpLabelPresel1 = "GJet Prompt Passing idMVA, Passing Presel, Failing Pt/M";
    string gjpLabelPresel2 = "GJet Prompt Passing idMVA, Failing Presel, Passing Pt/M";
    
    string gjfLabelUncut = "GJet Fake";
    string gjfLabelPresel = "GJet Fake Passing Presel & Pt/M";
//    string gjfLabelPresel = "GJet Fake W/ New idMVABarrel > -0.97735 & idMVAEndcap > 0.63704";
    string gjfLabelPresel1 = "GJet Fake Passing idMVA, Passing Presel, Failing Pt/M";
    string gjfLabelPresel2 = "GJet Fake Passing idMVA, Failing Presel, Passing Pt/M";
    
    string gghLabelUncut = "GGH*400";
    string gghLabelPresel = "GGH*400 Passing Presel & Pt/M";
//    string gghLabelPresel = "400*GGH W/ New idMVABarrel > -0.97735 & idMVAEndcap > 0.63704";
    string gghLabelPresel1 = "GGH*400 Passing idMVA, Passing Presel, Failing Pt/M";
    string gghLabelPresel2 = "GGH*400 Passing idMVA, Failing Presel, Passing Pt/M";
    
    string diLabelUncut = "Diphoton Bkg";
    string diLabelPresel = "Diphoton Bkg Passing Presel & Pt/M";
//    string diLabelPresel = "Diphoton Background W/ New idMVABarrel > -0.97735 & idMVAEndcap > 0.63704";
    string diLabelPresel1 = "Diphoton Bkg Passing idMVA, Passing Presel, Failing Pt/M";
    string diLabelPresel2 = "Diphoton Bkg Passing idMVA, Failing Presel, Passing Pt/M";

    string dirStr ="plots/0223/Presel/";
    int nEta;
    string etaCuts[4];
    string etaLabels[4];
    string etaFLabels[4];
    ...
    string allLabels[16] = {gjpLabelUncut,gjpLabelPresel,gjpLabelPresel1,gjpLabelPresel2,gjfLabelUncut,gjfLabelPresel,gjfLabelPresel1,gjfLabelPresel2,gghLabelUncut,gghLabelPresel,gghLabelPresel1,gghLabelPresel2,diLabelUncut,diLabelPresel,diLabelPresel1,diLabelPresel2};
    
    
    string outNameGen = dirStr + "GGHandGJet_PreselAnalysis";
...
//    string preselSub =  "";
    ...
    for (int e = 0; e < nEta; e++){
        string cutStringLeadLoose,cutStringSubLoose,cutStringLeadTight,cutStringSubTight,cutStringLeadPresel1,cutStringSubPresel1,cutStringLeadPresel2,cutStringSubPresel2;
        if(diphotonCuts == true){
            ...
            cutStringLeadPresel1 = etaCuts[e] + kinCutLeadLoose + kinCutSubLoose + preselLead + preselSub + "&& leadIDMVA > -0.98 && subIDMVA > -0.98 && !( leadPt > 17 " + kinCutLeadTight +")" + "&& !(subPt > 17 " + kinCutSubTight +"))*weight" ;
            cutStringSubPresel1 = etaCuts[e] + kinCutSubLoose + kinCutLeadLoose + preselSub + preselLead + "&& leadIDMVA > -0.98 && subIDMVA > -0.98 && !(subPt > 17 " + kinCutSubTight+ ")" + "&& !(leadPt > 17 " + kinCutLeadTight+ "))*weight";
            
            cutStringLeadPresel2 = etaCuts[e] + kinCutLeadTight + kinCutSubTight + "&& leadIDMVA > -0.98 && subIDMVA > -0.98 && !( leadPt > 17" + preselLead + preselSub + "))*weight";
            cutStringSubPresel2 = etaCuts[e] + kinCutSubTight + kinCutLeadTight + "&& leadIDMVA > -0.98 && subIDMVA > -0.98 && !( subPt > 17 " + preselSub + preselLead + + "))*weight";
        ...
        if(diphotonCuts == false){
            ...
            cutStringLeadPresel1 = etaCuts[e] + kinCutLeadLoose;
            cutStringSubPresel1 = etaCuts[e] + kinCutSubLoose;
            
            cutStringLeadPresel2 = etaCuts[e] + kinCutLeadLoose + "!( leadPt > 17 " + preselLead + kinCutLeadTight + ")";
            cutStringSubPresel2 = etaCuts[e] + kinCutSubLoose + "!( subPt > 17 " + preselSub + kinCutSubTight + ")";
...
//        for(int i = 3; i < 5; i++){
        for(int i = 0; i < 10; i++){
            ...
            TH1F *h[16];
            TH1F *hSub[16];
            string hNames[16] = {"hPUncut","hPPresel","hPreselP","hPreselP2","hFUncut","hFPresel","hPreselF","hPreselF2","hGGHUncut","hGGHPresel","hGGHPresel","hGGHPresel2","hDiphUncut","hDiphPresel","hDiphPresel","hDiphPresel2"};
            string hNamesSub[16] = {"hPUncutSub","hPPreselSub","hPreselPSub","hPreselPSub2","hFUncutSub","hFPreselSub","hPreselFSub","hPreselFSub2","hGGHUncutSub","hGGHPreselSub","hGGHPreselSub","hGGHPreselSub2","hDiphUncutSub","hDiphPreselSub","hDiphPreselSub","hDiphPreselSub2"};
            
            int jLo = 4;
            for(int j = jLo; j < nTrees; j++){
                ...
                if (j == 2){
                    cutStringLead = "(leadGenMatchType == 1 && subGenMatchType != 1" + massCutLoose + cutStringLeadPresel1;
                    cutStringSub = "(subGenMatchType == 1 && leadGenMatchType != 1" + massCutLoose + cutStringSubPresel1;
                }
                if (j == 3){
                    cutStringLead = "(leadGenMatchType == 1 && subGenMatchType != 1" + massCutLoose + cutStringLeadPresel2;
                    cutStringSub = "(subGenMatchType == 1 && leadGenMatchType != 1" + massCutLoose + cutStringSubPresel2;
                }
                if (j == 4){
                    cutStringLead = "(leadGenMatchType != 1 && subGenMatchType == 1" + massCutLoose + cutStringLeadLoose;
                    cutStringSub = "(subGenMatchType != 1 && leadGenMatchType == 1" + massCutLoose + cutStringSubLoose;
                ...
                if (varNames[i] == "hggMass"){
                    ...
                    if (j == 10){
                        cutStringLead = "(leadGenMatchType == 1 " + massCutLoose + cutStringLeadPresel1;
                        cutStringSub = "(subGenMatchType == 1" + massCutLoose + cutStringSubPresel1;
                    }
                    if (j == 11){
                        cutStringLead = "(leadGenMatchType == 1 " + massCutLoose + cutStringLeadPresel2;
                        cutStringSub = "(subGenMatchType == 1" + massCutLoose + cutStringSubPresel2;
                    }
                }
//                else {
//                    if (j == 8){
...
//                }
                    ...
                    if (j == 10){
                        cutStringLead = "(leadGenMatchType == 1 " + massCutTight + cutStringLeadPresel1;
                        cutStringSub = "(subGenMatchType == 1" + massCutTight + cutStringSubPresel1;
                    }
                    if (j == 11){
                        cutStringLead = "(leadGenMatchType == 1 " + massCutTight + cutStringLeadPresel2;
                        cutStringSub = "(subGenMatchType == 1" + massCutTight + cutStringSubPresel2;
                    }
                }
                if (j == 12){
                    cutStringLead = "(leadGenMatchType == 1 " + massCutLoose + cutStringLeadLoose;
