...
void allEtaScoreCutVarCompSignal(){
    gROOT->Reset();
    gStyle->SetPalette(1);
    ...
    string cutStringLeadIDMVAGen = "(leadGenMatchType == 1" + massCutSig + kinCutLeadLoose + kinCutSubLoose + idMVACutLead + idMVACutSub +")*weight";
    string cutStringSubIDMVAGen = "(subGenMatchType == 1" + massCutSig + kinCutSubLoose + kinCutLeadLoose + idMVACutSub + idMVACutLead + ")*weight";
    ...
    string cutStringLeadIDMVAMass = "(leadGenMatchType == 1" + massCutLoose + kinCutLeadLoose + kinCutSubLoose + idMVACutLead + idMVACutSub + ")*weight";
    string cutStringSubIDMVAMass = "(subGenMatchType == 1" + massCutLoose + kinCutSubLoose + kinCutLeadLoose + idMVACutSub + idMVACutLead + ")*weight";
    
    int nVars = 5;
    string varNames[5] = {"Pt","Pt/hggMass","hggMass","SigmaIetaIeta","IDMVA"};
    double limsLow[5] = {0.0,0.0,80.0,0.0,-1.0};
    double limsHigh[5] = {200,1.3,180,0.1,1.0};
