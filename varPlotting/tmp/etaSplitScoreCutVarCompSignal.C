...
void etaSplitScoreCutVarCompSignal(){
    gROOT->Reset();
    gStyle->SetPalette(1);
    ...
    string gghLabelIDMVA = "GGH W/ idMVA > -0.6";
    ...
    string vbfLabelIDMVA = "100*VBF W/ idMVA > -0.6";
    ...
    string tthLabelIDMVA = "500*TTH W/ idMVA > -0.6";
    ...
    string bbhLabelIDMVA = "500*HHTo2B2G W/ idMVA > -0.6";
    ...
    string outNameGen = "plots/1201/SignalVariableDistributions_idMVACut_1201";
    ...
    for (int e = 0; e < nEta; e++){
        ...
        string cutStringLeadLooseGen = "(leadGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseGen = "(subGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutSubLoose + kinCutLeadLoose + ")*weight";

        string cutStringLeadTightGen = "(leadGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightGen = "(subGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
        
        string cutStringLeadIDMVAGen = "(leadGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutLeadLoose + kinCutSubLoose + idMVACutLead + idMVACutSub +")*weight";
        string cutStringSubIDMVAGen = "(subGenMatchType == 1" + massCutSig + etaCuts[e] + kinCutSubLoose + kinCutLeadLoose + idMVACutSub + idMVACutLead + ")*weight";
        
        string cutStringLeadLooseMass = "(leadGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseMass = "(subGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutSubLoose + kinCutLeadLoose + ")*weight";
        
        string cutStringLeadTightMass = "(leadGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightMass = "(subGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";

        string cutStringLeadIDMVAMass = "(leadGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutLeadLoose + kinCutSubLoose + idMVACutLead + idMVACutSub + ")*weight";
        string cutStringSubIDMVAMass = "(subGenMatchType == 1" + massCutLoose + etaCuts[e] + kinCutSubLoose + kinCutLeadLoose + idMVACutSub + idMVACutLead + ")*weight";
