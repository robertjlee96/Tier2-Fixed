...
void etaSplitScoreCutVarCompBkg(){
    gROOT->Reset();
    gStyle->SetPalette(1);
    ...
    for (int e = 0; e < nEta; e++){
        ...
        string cutStringLeadLooseGenPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseGenPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + kinCutLeadLoose + ")*weight";
        
        string cutStringLeadTightGenPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightGenPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
        
        string cutStringLeadIDMVAGenPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + idMVACutLead + kinCutSubLoose + idMVACutSub + ")*weight";
        string cutStringSubIDMVAGenPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + idMVACutSub + kinCutLeadLoose + idMVACutLead + ")*weight";
        
        string cutStringLeadLooseMassPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseMassPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + kinCutLeadLoose + ")*weight";
        
        string cutStringLeadTightMassPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightMassPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
        
        string cutStringLeadIDMVAMassPrompt = "(leadGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + idMVACutLead + kinCutSubLoose + idMVACutSub + ")*weight";
        string cutStringSubIDMVAMassPrompt = "(subGenMatchType == 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + idMVACutSub + kinCutLeadLoose + idMVACutLead + ")*weight";
        
        string cutStringLeadLooseGenFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseGenFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + kinCutLeadLoose + ")*weight";
        
        string cutStringLeadTightGenFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightGenFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
        
        string cutStringLeadIDMVAGenFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + idMVACutLead + kinCutSubLoose + idMVACutSub + ")*weight";
        string cutStringSubIDMVAGenFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + idMVACutSub + kinCutLeadLoose + idMVACutLead + ")*weight";
        
        string cutStringLeadLooseMassFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + kinCutSubLoose + ")*weight";
        string cutStringSubLooseMassFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + kinCutLeadLoose + ")*weight";
        
        string cutStringLeadTightMassFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
        string cutStringSubTightMassFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
        
        string cutStringLeadIDMVAMassFake = "(leadGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutLeadLoose + idMVACutLead + kinCutSubLoose + idMVACutSub + ")*weight";
        string cutStringSubIDMVAMassFake = "(subGenMatchType != 1" + etaCuts[e] + massCutLoose + kinCutSubLoose + idMVACutSub + kinCutLeadLoose + idMVACutLead + ")*weight";
        ...
        for(int i = 0; i < nVars; i++){
            ...
            string plotTitleStr = varNames[i] + " Diphoton Cuts ";
            ...
            can->SetGrid();
            string outName;
            if (varNames[i] == "Pt/hggMass") outName = outNameGen + "_PtOvrM" + "_" + etaFLabels[e];
