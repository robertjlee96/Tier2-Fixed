...
void varCompSig(bool etaSplit,bool diphotonCuts){
    gROOT->Reset();
    gStyle->SetPalette(1);
...
//    bool etaSplit == false;
    ...
    string outNameGen = dirStr + "Signal";
    ...
    for (int e = 0; e < nEta; e++){
        ...
        string cutStringLeadLooseGen,cutStringSubLooseGen,cutStringLeadTightGen,cutStringSubTightGen,cutStringLeadLooseMass,cutStringSubLooseMass,cutStringLeadTightMass,cutStringSubTightMass;
